...
REM Game Build
cl -nologo -Zi -FC -WX %warnings_to_ignore% ..\code\win32_game.cpp  /link user32.lib gdi32.lib winmm.lib opengl32.lib %link%

:: Compile Game to DLL
REM cl -nologo -Zi -Od -Fmgame.map %code_path%game.cpp -LD /link %dll_link% -incremental:no -PDB:game_pdb_%random%.pdb user32.lib gdi32.lib winmm.lib
